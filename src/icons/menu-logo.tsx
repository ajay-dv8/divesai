...
export const MenuLogo = ({ onClick }: MenuLogoProps) => {
  return (  
    <> 
    <Menu onClick={onClick} width="20" height="20" />
    ...
    //         fill="#25CAAC">
    //       </path> 
    //         <path d="M13.2464 21.4315C15.1716 22.7743 18.293 22.7743 20.2182 21.4315C22.1434 20.0886 22.1434 17.9114 20.2182 16.5685C18.293 15.2257 15.1716 15.2257 13.2464 16.5685C11.3212 17.9114 11.3212 20.0886 13.2464 21.4315Z" 
    //         fill="#25CAAC">
    //         </path> 
    //         <path d="M0.866345 20.4589C2.02147 21.2646 3.8943 21.2646 5.04943 20.4589C6.20455 19.6532 6.20455 18.3469 5.04943 17.5411C3.8943 16.7354 2.02147 16.7354 0.866345 17.5411C-0.288782 18.3469 -0.288781 19.6532 0.866345 20.4589Z" 
    //         fill="#25CAAC"
    //         >
    //         </path> 
    //         <path 
